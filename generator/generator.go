...
func (g *generator) writeCodeGeneratedComment() (err error) {
	_, err = g.w.Write("// Code generated by thunderf1sh - DO NOT EDIT.\n\n")
	return err
}

func (g *generator) writeVersionComment() (err error) {
	if g.version != "" {
		_, err = g.w.Write("// thunderf1sh(t1): version: " + g.version + "\n")
	}
	return err
}
...
func (g *generator) writeGeneratedDateComment() (err error) {
	if g.generatedDate != "" {
		_, err = g.w.Write("// thunderf1sh: generated: " + g.generatedDate + "\n")
	}
	return err
}
...
func (g *generator) writeO8(t parser.O8Template) error {
	...
	g.sourceMap.Add(t.Parameters, r)
	// ) templ.ComponentO8 {
	if _, err = g.w.Write(") templ.ComponentO8 {\n"); err != nil {
		return err
	}
	indentLevel++
	// return templ.ComponentO8{
	if _, err = g.w.WriteIndent(indentLevel, "return templ.ComponentO8{\n"); err != nil {
		return err
	}
	{
		indentLevel++
