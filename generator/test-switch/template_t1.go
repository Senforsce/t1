...
func render(input string) t1.Component {
	return t1.ComponentFunc(func(ctx context.Context, t1_7745c5c3_W io.Writer) (t1_7745c5c3_Err error) {
		...
		case "a":
			...
			if t1_7745c5c3_Err != nil {
				return t1.Error{Err: t1_7745c5c3_Err, FileName: `generator/test-switch/template.t1`, Line: 5, Col: 17}
			}
		...
		default:
			...
			if t1_7745c5c3_Err != nil {
				return t1.Error{Err: t1_7745c5c3_Err, FileName: `generator/test-switch/template.t1`, Line: 7, Col: 28}
			}
