...
func (d Data) Method() t1.Component {
	return t1.ComponentFunc(func(ctx context.Context, t1_7745c5c3_W io.Writer) (t1_7745c5c3_Err error) {
		...
		t1_7745c5c3_Var2, t1_7745c5c3_Err = t1.JoinStringErrs(d.message)
		if t1_7745c5c3_Err != nil {
			return t1.Error{Err: t1_7745c5c3_Err, FileName: `generator/test-method/template.t1`, Line: 7, Col: 17}
		}
