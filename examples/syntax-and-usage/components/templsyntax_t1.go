...
func list(items []string) t1.Component {
	return t1.ComponentFunc(func(ctx context.Context, t1_7745c5c3_W io.Writer) (t1_7745c5c3_Err error) {
		...
		_, t1_7745c5c3_Err = t1_7745c5c3_Buffer.WriteString("<ol>")
		...
		for _, item := range items {
			...
			t1_7745c5c3_Var2, t1_7745c5c3_Err = t1.JoinStringErrs(item)
			if t1_7745c5c3_Err != nil {
				return t1.Error{Err: t1_7745c5c3_Err, FileName: `examples/syntax-and-usage/components/templsyntax.t1`, Line: 5, Col: 13}
			}
